...
module neo_c1(
	...
	c1_wait C1WAIT(CLK, CLK_EN_68K_P, nAS, SYSTEM_TYPE[1], TURBO_SPEED, nROM_ZONE, nWRAM_ZONE, nPORT_ZONE, nCARD_ZONE, nSROM_ZONE,
					nLSPC_ZONE, nPAL_ZONE, nROMWAIT, nPWAIT0, nPWAIT1, PDTACK, nDTACK);
